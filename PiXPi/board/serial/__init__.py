...
from board.serial.serialutil import *
...
if sys.platform == 'cli':
    from board.serial.serialcli import Serial
else:
    import os
    ...
    if os.name == 'nt':  # sys.platform == 'win32':
        ...
        from board.serial.serialposix import Serial, PosixPollSerial, VTIMESerial  # noqa
    elif os.name == 'java':
